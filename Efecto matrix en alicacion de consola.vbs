Module Module1
    Sub Main()
        ...
        Console.WindowHeight = 30 ' InlineAssignHelper(Console.BufferHeight, Console.LargestWindowHeight)
        Console.WindowWidth = 100 ' InlineAssignHelper(Console.BufferWidth, Console.LargestWindowWidth)
